 ...
 * @see https://github.com/sebbmeyer/php-microsoft-teams-connector/blob/master/src/Cards/Adaptive/Elements/Image.php
 */
class Image extends BaseElement implements AdaptiveCardElementInterface
{
     ...
     * @return Image
     */
    public function setHorizontalAlignment(string $alignment)
    {
